function [b_orig, b_anti, b_orig_norm,b_anti_norm] = er_pac_3(data,fs,segleng,segshift,epleng,filt)
% Estimates PAC using bispectra assuming that data is 6 channels 3 pcs of first roi and second roi 
...
% 
% Copyright (c) 2025 Franziska Pellegrini and Stefan Haufe
